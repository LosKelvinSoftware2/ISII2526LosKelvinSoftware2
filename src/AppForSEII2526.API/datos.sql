...
----------------------------------------------------------
-- DATOS DE PRUEBA: ApplicationUser
----------------------------------------------------------
INSERT INTO dbo.ApplicationUser (Id, UserName, Nombre, Apellido, Telefono, CorreoElectronico)
VALUES
('U001', 'juanperez', 'Juan', 'Pérez', '600111222', 'juan.perez@email.com'),
('U002', 'mariagonz', 'María', 'González', '600111333', 'maria.gonzalez@email.com'),
('U003', 'carlosdiaz', 'Carlos', 'Díaz', '600111444', 'carlos.diaz@email.com'),
('U004', 'lauramart', 'Laura', 'Martínez', '600111555', 'laura.martinez@email.com'),
('U005', 'andresro', 'Andrés', 'Rodríguez', '600111666', 'andres.rodriguez@email.com'),
('U006', 'anatorres', 'Ana', 'Torres', '600111777', 'ana.torres@email.com'),
('U007', 'pedroalv', 'Pedro', 'Álvarez', '600111888', 'pedro.alvarez@email.com'),
('U008', 'sofiacruz', 'Sofía', 'Cruz', '600111999', 'sofia.cruz@email.com'),
('U009', 'josemejia', 'José', 'Mejía', '600222111', 'jose.mejia@email.com'),
('U010', 'martalop', 'Marta', 'López', '600222222', 'marta.lopez@email.com'),
('U011', 'lucasram', 'Lucas', 'Ramírez', '600222333', 'lucas.ramirez@email.com'),
('U012', 'rociogar', 'Rocío', 'García', '600222444', 'rocio.garcia@email.com'),
('U013', 'danielher', 'Daniel', 'Hernández', '600222555', 'daniel.hernandez@email.com'),
('U014', 'susanaor', 'Susana', 'Ortega', '600222666', 'susana.ortega@email.com'),
('U015', 'jorgemol', 'Jorge', 'Molina', '600222777', 'jorge.molina@email.com'),
('U016', 'carmentru', 'Carmen', 'Trujillo', '600222888', 'carmen.trujillo@email.com'),
('U017', 'manuelro', 'Manuel', 'Romero', '600222999', 'manuel.romero@email.com'),
('U018', 'inesruiz', 'Inés', 'Ruiz', '600333111', 'ines.ruiz@email.com'),
('U019', 'antoniofe', 'Antonio', 'Fernández', '600333222', 'antonio.fernandez@email.com'),
('U020', 'saraloz', 'Sara', 'López', '600333333', 'sara.lopez@email.com');

----------------------------------------------------------
-- DATOS DE PRUEBA: Compra
----------------------------------------------------------
INSERT INTO dbo.Compra (Id, ClienteId, DireccionEnvio, FechaCompra, PrecioTotal, MetodoPago)
VALUES
...
----------------------------------------------------------
-- DATOS DE PRUEBA: CompraItem
----------------------------------------------------------
INSERT INTO dbo.CompraItem (herramientaId, compraId, cantidad, descripcion, precio)
VALUES
...
----------------------------------------------------------
-- DATOS DE PRUEBA: Alquiler
----------------------------------------------------------
INSERT INTO dbo.Alquiler (Id, DireccionEnvio, FechaAlquiler, FechaFin, PrecioTotal, MetodoPago, NombreCliente, ApellidoCliente, ClienteId)
VALUES
...
----------------------------------------------------------
-- DATOS DE PRUEBA: AlquilarItem
----------------------------------------------------------
INSERT INTO dbo.AlquilarItem (herramientaId, alquilerId, cantidad, precio)
VALUES
(1, 1, 1, 80.00),
(2, 2, 2, 150.00),
(3, 3, 1, 90.00),
...
----------------------------------------------------------
-- DATOS DE PRUEBA: Reparacion
----------------------------------------------------------
INSERT INTO dbo.Reparacion (Id, FechaEntrega, FechaRecogida, PrecioTotal, MetodoPago, ClienteId)
VALUES
...
----------------------------------------------------------
-- DATOS DE PRUEBA: ReparacionItem
----------------------------------------------------------
...
----------------------------------------------------------
INSERT INTO dbo.Oferta (Id, fechaInicio, fechaFinal, fechaOferta, metodoPago, dirigidaA)
VALUES
(1, '2025-01-01', '2025-01-31', '2025-01-15', 0, 0),
(2, '2025-02-01', '2025-02-28', '2025-02-15', 1, 1),
(3, '2025-03-01', '2025-03-31', '2025-03-20', 2, 0),
(4, '2025-04-01', '2025-04-30', '2025-04-10', 0, 1),
(5, '2025-05-01', '2025-05-31', '2025-05-15', 1, 0),
(6, '2025-06-01', '2025-06-30', '2025-06-20', 2, 1),
(7, '2025-07-01', '2025-07-31', '2025-07-10', 0, 0),
(8, '2025-08-01', '2025-08-31', '2025-08-15', 1, 1),
(9, '2025-09-01', '2025-09-30', '2025-09-20', 2, 0),
(10, '2025-10-01', '2025-10-31', '2025-10-15', 0, 1),
(11, '2025-11-01', '2025-11-30', '2025-11-15', 1, 0),
(12, '2025-12-01', '2025-12-31', '2025-12-20', 2, 1),
(13, '2025-01-01', '2025-01-15', '2025-01-05', 0, 0),
(14, '2025-02-10', '2025-02-20', '2025-02-12', 1, 1),
(15, '2025-03-05', '2025-03-25', '2025-03-10', 2, 0),
(16, '2025-04-05', '2025-04-25', '2025-04-15', 0, 1),
(17, '2025-05-10', '2025-05-30', '2025-05-20', 1, 0),
(18, '2025-06-10', '2025-06-25', '2025-06-15', 2, 1),
(19, '2025-07-01', '2025-07-15', '2025-07-05', 0, 0),
(20, '2025-08-01', '2025-08-20', '2025-08-10', 1, 1);

----------------------------------------------------------
-- DATOS DE PRUEBA: OfertaItem
----------------------------------------------------------
